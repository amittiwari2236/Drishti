        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <StatCard
              ...
              value={result.metrics.totalProjects}
              icon={FolderKanban}
            />
            <StatCard
              title="On-Track Projects"
              value={result.metrics.onTrackProjects}
              icon={CheckCircle2}
              accent="bg-emerald-500/10 text-emerald-600"
            />
            <StatCard
              title="Delayed Projects"
              value={result.metrics.delayedProjects}
              icon={Clock}
              accent={
                result.metrics.delayedProjects > 0
            ...
            <StatCard
              ...
              value={result.metrics.criticalProjects}
              icon={AlertOctagon}
              accent={
                result.metrics.criticalProjects > 0
            ...
            <StatCard
              title="Cost Overruns"
              value={result.metrics.costOverrunProjects}
              icon={TrendingUp}
              accent={
                result.metrics.costOverrunProjects > 0
                  ? "bg-red-500/10 text-red-600"
                  : undefined
              }
            />
